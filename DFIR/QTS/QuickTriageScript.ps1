...
# Look for thread injection
Add-Content $f\ActivityRecord.txt ""
Add-Content $f\ActivityRecord.txt "Checking for thread injection"
$h = Get-InjectedThread
$a = Get-Variable -Name "Check"
$check = $a.value
Add-Content $f\ActivityRecord.txt $check
if ($check = "Injection Found") {
    Add-Content $f\ActivityRecord.txt $h
    }
Add-Content $f\ActivityRecord.txt ""
...
Add-Content $f\ActivityRecord.txt "Check Completed"
Add-Content $f\ActivityRecord.txt ""
...
function Get-InjectedThread
{
    ...
    Set-Variable -Name "Check" -Value "No Injection Found" -Scope Global
            ...
            if($hThread -ne 0)
            {
                ...
                if($hProcess -ne 0)
                {
                    ...
                    {   
                        ...
                        Set-Variable -Name "Check" -Value "Injection Found" -Scope Global
                    }
